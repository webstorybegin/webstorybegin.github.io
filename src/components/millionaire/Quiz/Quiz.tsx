...
import { Choice, EndPage } from "components/millionaire";
import { Burger, Timer } from "components/millionaire/ui";
...
export const Quiz: FC<IQuiz> = ({ start, setStart }) => {
  ...
  useEffect(() => {
    questionNumber > 1 &&
      setEarned(money.find((item) => item.id === questionNumber - 1).amount);
  }, [questionNumber]);
